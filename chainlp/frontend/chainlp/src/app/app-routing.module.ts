...
import { ProjectInsightsComponent } from './pages/project/project-insights/project-insights.component';

const routes: Routes = [
  { path: '', component: ProjectListingComponent },
  { path: 'projects', component: ProjectListingComponent },
  { path: 'projects/insights', component: ProjectInsightsComponent },
