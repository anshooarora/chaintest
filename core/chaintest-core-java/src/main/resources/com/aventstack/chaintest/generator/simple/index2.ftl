                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col text-center">
                          ...
                          <p class="fw-semibold mb-0">${build.startedAt?number_to_datetime?string(config['datetimeFormat'])}
                          </p>
                        </div>
                    ...
                    <div class="card-footer">
                      <#if build.runStats?? && build.runStats?size !=0 && build.runStats[0].total !=0>
                        <#assign passRate=(build.runStats[1].passed/build.runStats[1].total)*100>
                          <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="${passRate}"
